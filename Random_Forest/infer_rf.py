...
# ==== FILE PATHS ====
model_dir = 'Models'
rf_dir = f'{model_dir}/RandomForest'
...
# ==== LOAD MODELS ====
models = {
    'bowler_style': joblib.load(f'{rf_dir}/Bowler_Bowling_Style_safe_best_model .pkl'),
    'pitch_length': joblib.load(f'{rf_dir}/pitchLength_safe_best_model.pkl'),
    'pitch_line': joblib.load(f'{rf_dir}/pitchLine_safe_best_model.pkl'),
    'shot_type': joblib.load(f'{rf_dir}/shot_type_best_model.pkl')
}
