...
dmatrix = xgb.DMatrix(scaled_inputs)

# ==== LOAD MODELS ====
models = {
    'bowler_style': joblib.load(f'{xgb_dir}/xgb_model_Bowler_Bowling_Style_safe.pkl'),
    'pitch_length': joblib.load(f'{xgb_dir}/xgb_model_pitchLength_safe.pkl'),
    'pitch_line': joblib.load(f'{xgb_dir}/xgb_model_pitchLine_safe.pkl'),
    'shot_type': joblib.load(f'{xgb_dir}/xgb_model_shotType_safe.pkl')
}
